...
export class URI implements UriComponents {
  ...
  static revive(
    ...
    if (!data) {
      ...
      result._formatted = (data as UriState).external ?? null;
      result._fsPath =
        (data as UriState)._sep === _pathSepMarker
          ? (data as UriState).fsPath ?? null
          : null;
      return result;
    }
  }
...
export function isUriComponents(thing: any): thing is UriComponents {
  ...
  return (
    typeof (thing as UriComponents).scheme === 'string' &&
    (typeof (thing as UriComponents).authority === 'string' ||
      typeof (thing as UriComponents).authority === 'undefined') &&
    (typeof (thing as UriComponents).path === 'string' ||
      typeof (thing as UriComponents).path === 'undefined') &&
    (typeof (thing as UriComponents).query === 'string' ||
      typeof (thing as UriComponents).query === 'undefined') &&
    (typeof (thing as UriComponents).fragment === 'string' ||
      typeof (thing as UriComponents).fragment === 'undefined')
  );
}
