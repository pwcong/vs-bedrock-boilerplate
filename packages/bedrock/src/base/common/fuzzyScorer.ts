...
import { createMatches as createFuzzyMatches, fuzzyScore, IMatch, isUpper, matchesPrefix } from '@/base/common/filters';
import { hash } from '@/base/common/hash';
import { sep } from '@/base/common/path';
import { isLinux, isWindows } from '@/base/common/platform';
import { equalsIgnoreCase, stripWildcards } from '@/base/common/strings';
