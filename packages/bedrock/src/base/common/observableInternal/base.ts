...
import { strictEquals, EqualityComparer } from '@/base/common/equals';
import { DisposableStore, IDisposable } from '@/base/common/lifecycle';
import { keepObserved, recomputeInitiallyAndOnChange } from '@/base/common/observable';
import { DebugNameData, IDebugNameData, Owner, getFunctionName } from '@/base/common/observableInternal/debugName';
import type { derivedOpts } from '@/base/common/observableInternal/derived';
